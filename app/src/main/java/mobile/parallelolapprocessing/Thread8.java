 ...
 */
public class Thread8 extends AsyncTask {
    ...
    public Thread8(List<List<List<Integer>>> allAxisDetails, List<Integer> selectedMeasures, HashMap<Integer, String> measureMap,
    ...
    public Thread8()
    {
        if(Thread8.inflatedQueries == null)
        {
            Thread8.inflatedQueries = new ArrayList<>();
        }
    ...
    protected Object doInBackground(Object[] params) {
        Log.d("Inflated Query 7:", "Time taken to start job " + String.valueOf(System.currentTimeMillis()));
        this.run();
        long end = System.currentTimeMillis();
        Log.d("Inflated Query 7:", "Time taken to finish job " + String.valueOf(end));
