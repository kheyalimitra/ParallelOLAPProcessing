 ...
 */
public class Thread7 extends AsyncTask {
    ...
    public Thread7(List<List<List<Integer>>> allAxisDetails, List<Integer> selectedMeasures, HashMap<Integer, String> measureMap,
    ...
    public Thread7()
    {
        if(Thread7.inflatedQueries == null)
        {
            Thread7.inflatedQueries = new ArrayList<>();
        }
    ...
    protected Object doInBackground(Object[] params) {
        Log.d("Inflated Query 6:", "Time taken to start job " + String.valueOf(System.currentTimeMillis()));
        this.run();
        long end = System.currentTimeMillis();
        Log.d("Inflated Query 6:", "Time taken to finish job " + String.valueOf(end));
